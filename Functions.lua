...
local Functions = {
    ...
    Executor = (identifyexecutor and identifyexecutor() or syn and "Synapse X" or "Unknown"),
}
local ModuleScripts = {}
local function convertToAsset(str)
    ...
    elseif str:find("http") then
      ...
      warn("The Url Or Request Or Page Is Incorrect Please Put A Valid URL NOT AN INVALID ONE")
        end
    else
    warn("The Request Assigned Was Incorrect")
    end
    return str
end
...
Functions.GetExecutor = function()
  return Functions.Executor
  end
